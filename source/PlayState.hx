...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.RED, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		timeBar.createFilledBar(0xFF000000, 0xFFFFBB1B);
		...
		watermark = new FlxText(scoreTxt.x + 30, scoreTxt.y, 0, songName " | FNF | Hex Falc Engine (Psych 0.5.2)", 20);
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "Playtesting(No Score)", 32);
